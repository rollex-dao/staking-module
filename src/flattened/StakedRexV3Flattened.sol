...
// src/contracts/RexDistributionManager.sol
...
// src/interfaces/IStakedRexV3.sol
...
// src/lib/GovernancePowerDelegationERC20.sol
  ...
  RexDistributionManager
{
  ...
  ) ERC20() RexDistributionManager(emissionManager, distributionDuration) {
